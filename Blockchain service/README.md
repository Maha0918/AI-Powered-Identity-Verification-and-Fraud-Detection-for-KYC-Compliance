...
Recommended local defaults in this repository:

- Blockchain server: `http://localhost:5002`
- Blockchain client: `http://localhost:5174`
- Main project backend/frontend remain on `5000/5173`
